...
function InventoryCatalog() {
    ...
    // Remove local form state, use CatalogForm for adding items
    ...
    // Filtering logic can be refactored to use a separate filter state if needed
    ...
    return (
        <><div className="inventory-catalog">
            ...
            <CatalogForm
                onSave={async (form) => {
                    const res = await api.post("/api/catalog", form);
